  ...
  return (
    <div className="flex flex-col min-h-svh">
      ...
      <main className="container mx-auto flex flex-col flex-1 px-4">
        <section className="grid gap-4 py-8 md:grid-cols-2 md:py-40">
          ...
          <div className="group place-self-center grid p-9">
            <div className="flex justify-center items-center col-start-1 z-3 row-start-1 transition-all duration-200 group-hover:rotate-12 origin-bottom-right size-52 bg-accent rounded-md shadow rotate-0">
              <img
                className="size-44 rounded-md grayscale group-hover:grayscale-0 transition-all duration-200"
                src="/me.jpg"
                alt="Jenia Brook"
              />
            </div>
            <div className="col-start-1 z-2 row-start-1 size-52 bg-interactive rounded-md shadow"></div>
            <div className="col-start-1 row-start-1 size-52 transition-all duration-200 group-hover:-rotate-12 origin-bottom-right z-0 bg-main rounded-md shadow rotate-0"></div>
          </div>
        </section>
      </main>
    </div>
